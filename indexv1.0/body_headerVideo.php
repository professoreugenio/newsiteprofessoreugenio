<header class="bg-cycle position-relative text-white text-center">
    ...
    <div class="bg-images d-flex">
        <img src="https://professoreugenio.com/img/excel/bg1.jpg?<?= time(); ?>" alt="Background 1" class="bg-img">
        <img src="https://professoreugenio.com/img/excel/bg2.jpg?<?= time(); ?>" alt="Background 2" class="bg-img">
        <img src="https://professoreugenio.com/img/excel/bg3.jpg?<?= time(); ?>" alt="Background 3" class="bg-img">
    </div>
        ...
        <!-- <div id="videoWrapper">
            ...
            <div class="text-center">
                <video id="meuVideo" controls poster="img/capaapresentacao.jpg">
                    <source src="videos/publicacoes/174957741820250610/Conectando_a_arquivos_JSON_6851bdb110880.mp4" type="video/mp4">
                    <track src="videos/publicacoes/174957741820250610/Conectando_a_arquivos_JSON_6851bdb110880.vtt" kind="subtitles" srclang="pt" label="Português" default>
