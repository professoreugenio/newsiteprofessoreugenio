        ...
        <div class="col-md-9">
            <div id="cabecalhoAulas" class="p-3 bg-dark text-light rounded-3 shadow-sm mb-3 border border-secondary">
                ...
                <div class="text-center border-top pt-2">
                    ...
                    <h5>Seguem abaixo as atividades desta lição!</h5>
                </div>
            </div>
            <?php if (!empty($codigoUser) && $codigoUser == 1): ?>
                <h5 class="text-center">
                    Comercial <?= $comercialDados; ?> { Curso:<?= $nmCurso; ?> }{ IdTurma:<?= $idTurma; ?> }{ IdCurso: <?= $codigocurso; ?> }{ IdAula: <?= $codigoaula; ?> }{ Liberada: <?= $aulaLiberada; ?> }{ Pasta: <?= $pasta; ?> }
                </h5>
            <?php endif; ?>

            <?php require 'paginas/body_modulo_AtividadeFormPrint.php' ?>
        </div>
    </div>
</main>
<!-- Rodapé -->
