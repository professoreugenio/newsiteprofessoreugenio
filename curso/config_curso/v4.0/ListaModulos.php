            ...
            ?>
                ...
                <div class="col">
                    <div class="card shadow-lg border-0 rounded-4 text-white module-card"
                        ...
                        <div class="card-body p-3" style="background: rgba(0,0,0,0.25); height: 100%; position: relative;">
                            <!-- Progresso -->
                ...
                WHERE idalunoaa = :idusuario AND idturmaaa = :idturma AND idmoduloaa = :idmodulo ORDER BY dataaa DESC LIMIT 1 ");
                    ...
                    <?php if ($codigoUser == 1): ?>
                        <div style="position: absolute;top: 10px; right: 10px;background: rgba(0,0,0,0.5); padding: 5px; border-radius: 5px;z-index: 9100;">
                            <a target="_blank" class="btn" href="../../pdf/pdf.php?var=<?= $enc; ?>">PDF</a>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
