...
foreach ($comentarios as $c) {
    ...
    if ($idUser === $idAutor) {
        ...
        echo "    <div class='small text-white-50 mb-1'><small>em {$data} às {$hora}</small></div>";
        echo "  </div>";
        echo "  <div class='d-flex justify-content-end'>";
        echo "    <div class='bg-light text-dark p-2' style='max-width:85%; border-radius:8px 0 8px 8px;'>";

        echo "      <div class='text-end' style='min-width:100px'><i>{$texto}</i></div>";
        echo "    </div>";
        echo "  </div>";
        echo "</div>";
    } else {
        ...
        echo "    <img src='{$foto}' class='rounded-circle me-2 d-none d-sm-block' width='40' height='40' alt='{$nome}'>";
        echo "    <div class='w-100'>";
        echo "      <div class='small text-white-50 mb-1'><small>em {$data} às {$hora}</small></div>";
        echo "      <div class='text-dark p-2' style='background-color:#e9e9deff; border-radius:0 8px 8px 8px;'>";
        echo "        <div class='mb-1'><strong title='{$nomeCompleto}'>{$nome}</strong></div>";
