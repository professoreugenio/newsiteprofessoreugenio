...
foreach ($alunos as $a) {
    ...
    <div class='text-center'>
        ...
        <div class='small mt-1 text-white ' style='max-width: 80px; overflow: hidden;font-size:10px'>$primeiroNome</div>
    </div>";
}

if (!empty($codigoUser) && $codigoUser == 1): ?>
    <small class="text-center">
        Usuário <?= $codigoUser; ?> Comercial <?= $comercialDados; ?> { Curso:<?= $nmCurso; ?> }{ IdTurma:<?= $idTurma; ?> }{ IdCurso: <?= $codigocurso; ?> }{ IdAula: <?= $codigoaula; ?> }{ Liberada: <?= $aulaLiberada; ?> }{ Pasta: <?= $pasta; ?> }
    </small>
<?php endif; ?>