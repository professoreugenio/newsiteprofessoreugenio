...
<!-- Player de Vídeo -->
<?php
// Consulta os vídeos vinculados à aula
...
// Conta os vídeos encontrados
$quantVideo = count($fetchVideos); $quantVideo;

// Exibe o primeiro vídeo, se houver
if ($quantVideo >= 1):
    $video = $fetchVideos[0]; // Pega o primeiro vídeo
...
<div>
    ...
    <ul>
        ...
        <li>Adicione um estilo CSS para alterar a cor do fundo</li>
        <li>Insira um botão com JavaScript que exibe uma mensagem ao clicar</li>
    </ul>
</div>