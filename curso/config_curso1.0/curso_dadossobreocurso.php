            ...
            <div class="card border-0 bg-white shadow-sm p-4 rounded-4">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mt-4">
                            <h6 class="fw-bold">📅 Data Início:</h6>
                            <p class="mb-2"><?php echo databr($datainicio); ?></p>
                            ...
                            <p class="mb-2"><span class="badge bg-info text-dark"><?php echo $cargahoraria; ?></span></p>
                            <h6 class="fw-bold">📲 Suporte via WhatsApp:</h6>
                            <a href="https://wa.me/5585996537577" target="_blank" class="btn btn-success btn-sm shadow-sm">
                                <i class="bi bi-whatsapp"></i> Falar com o Professor
                            </a>
