        ...
        <div class="video-content">
            ...
            <div class="mb-4 ml-4 mr-4">
                <div class="ratio ratio-16x9 mb-4">
                    <video id="video-aula" controls poster="capavideo.jpg" class="rounded-4 shadow-lg w-100" style="object-fit: cover;">
                        <source src="<?= htmlspecialchars($videoPath) ?>" type="video/mp4">
                        <track src="<?php echo preg_replace('/\.mp4$/', '.vtt', $videoPath); ?>" kind="subtitles" srclang="pt" label="Português" default>
