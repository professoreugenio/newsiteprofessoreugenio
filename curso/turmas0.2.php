...
<body style="margin-top: 0px;">
    ...
    <section id="Corpo" class="bg-dark">
        <div class="container text-center mt-4">
            ...
            <header class="container section-gap mt-4" style="margin-top: 100px;">
                <div class="row align-items-center g-3 mt-4">
                    <div class="col-lg-8 mt-4" data-aos="fade-right">
                        <h3 class="h4 mb-1">Olá, <span class="fw-bold"><?= $nmUser ?></span>! 👋</h3>
                        <p class="mb-0 text-white">Aqui estão seus cursos inscritos. Selecione um card para continuar.</p>
                    </div>
                    <div class="col-lg-4 text-lg-end" data-aos="fade-left">
                        <span class="badge badge-soft px-3 py-2">
                            <i class="bi bi-clock-history me-1"></i>
                            Último acesso ao sistema: <strong id="ultimoAcessoSistema">
                                <?= $ultimadata ?>
                                <?= $ultihorai ?>
            ...
            <div class="modal-content shadow-lg border-0 rounded-4 overflow-hidden">
                ...
                <div class="modal-header border-0 p-4 position-relative">
                    <div class="d-flex align-items-center gap-2" data-aos="fade-down">
                        ...
                        <h5 class="modal-title m-0" id="modalBoasVindasLabel">
                            👋 Olá, <strong><?php echo htmlspecialchars($nmUser); ?></strong>!
                        </h5>
                    </div>
                ...
                <!-- Corpo -->
                <div class="modal-body p-4 bg-curso-dark">
                    <div class="texto-acolhimento text-center">
                        <h5 class="fw-bold mb-2" data-aos="zoom-in">
                            <?php echo $saudacao; ?> <?php echo $nmUser; ?>
                        </h5>
                        <h6 class="fw-bold mb-2" data-aos="zoom-in">
                            , seja bem-vindo de volta!
                        </h6>
                        <!-- <p class="mb-0 text-light opacity-90" data-aos="fade-up" data-aos-delay="100">
                            Escolha abaixo uma das suas turmas para continuar seus estudos.
                        </p> -->
                    </div>

                    <!-- Chips/Badges sugestivas (opcional) -->
                    <!-- <div class="d-flex justify-content-center gap-2 flex-wrap mt-3" data-aos="fade-up" data-aos-delay="150">
                        <span class="badge badge-soft">Aulas semanais</span>
                        <span class="badge badge-soft">Vídeo aulas</span>
                        <span class="badge badge-soft">Atividades & Materiais</span>
                        <span class="badge badge-soft">Suporte do professor</span>
                    </div> -->
                </div>

                <!-- Rodapé -->
                <div class="modal-footer d-flex justify-content-between align-items-center bg-curso-dark border-0 p-3">
                    <small class="text-secondary" data-aos="fade-right">Bom estudo! 🚀</small>
                    <div class="d-flex gap-2" data-aos="fade-left">
                        <a href="#minhasTurmas" class="btn btn-warning fw-semibold px-3" data-bs-dismiss="modal">
                            Ver meus cursos
                        </a>
