...
<head>
    ...
    <link rel="stylesheet" href="config_curso1.0/CSS_slideDown.css?<?php echo time(); ?>">
    <link rel="stylesheet" href="config_default1.0/Css_config_loader.css">
    ...
    <link rel="stylesheet" href="config_aulas1.0/CSS_sidebarLateral.css?<?php echo time(); ?>">
        ...
        <div class="container-fluid d-flex justify-content-center mt-4">
            <div class="row w-100">
                ...
                <div class="col-md-12 pt-4">
                    ...
                    <?php
                    require 'config_curso1.0/v2.0/curso_dadossobreocurso.php';
