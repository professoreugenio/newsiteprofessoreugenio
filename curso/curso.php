    ...
    <section id="listaaulas">
        <div class="container-fluid d-flex justify-content-center mt-4">
            <div class="row w-100">
                ...
                <div class="col-md-9">
                    <?php $startModo;  ?>
                    <?php if (empty($codigoaula)):
                        require 'config_curso1.0/curso_modulo_status.php';
                    else:
                        require 'config_curso1.0/curso_modulo_licao.php';
                ...
                <div class="col-md-3 border-end border-secondary ps-4 bg-dark text-light ">

                    <div class="accordion " id="accordionAulas"
                        style="position: sticky; top: 90px; height: 100vh; overflow-y: auto;">

                        <?php require 'config_curso1.0/listaLicoes.php'; ?>
