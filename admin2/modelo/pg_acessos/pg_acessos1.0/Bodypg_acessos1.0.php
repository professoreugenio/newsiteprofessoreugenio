<?php
/**
 * Bodypg_acessos1.0.php
 * Estrutura base para o conteúdo principal da página pg_acessos
 */
?>
<div class="card shadow-sm" data-aos="fade-up">
    <div class="card-body">
        <h5 class="card-title text-primary mb-3">Bem-vindo à página pg_acessos</h5>
        <p class="text-muted">
