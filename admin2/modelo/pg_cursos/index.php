...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php require_once APP_ROOT . '/admin2/modelo/pg_cursos/pg_cursos1.0/Subnav.php'; ?>
        </div>
        <?php require_once APP_ROOT . '/admin2/modelo/pg_cursos/pg_cursos1.0/Bodypg_cursos1.0.php'; ?>
    </div>
    <!-- Scripts -->
