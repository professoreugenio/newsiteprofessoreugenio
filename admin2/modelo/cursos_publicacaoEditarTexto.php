...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <!-- CORPO PÁGINA -->
        <?php require_once APP_ROOT . '/admin2/modelo/publicacoesv1.0/BodyPublicacaoEditarTexto.php'; ?>
    </div>
    <!-- Scripts -->
    ...
    <?php require 'publicacoesv1.0/require_FotosPainel.php'; ?>
    ...
    <script src="publicacoesv1.0/summernote_config.js"></script>
