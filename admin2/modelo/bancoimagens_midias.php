...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="mt-4">
                <h3>
                    <i class="bi bi-camera" aria-hidden="true"></i> Banco de Imagens  / <?= $nmGaleria ?? 'Nova Galeria' ?>
        ...
        <?php echo $Pasta = date('M') . "_" . date('Ymd') . time();;  ?>
        <?php require_once APP_ROOT . '/admin2/modelo/bancodeImagens1.0/BodyBancoImagens_galeriaMidias.php'; ?>
    </div>
    <!-- Scripts -->
