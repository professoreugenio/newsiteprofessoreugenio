...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="mt-4">
                <h3><i class="bi bi-journal-text me-2"></i> pg_portfolio</h3>
            </div>
            <?php require_once APP_ROOT . '/admin2/modelo/pg_portfolio/pg_portfolio1.0/Subnav.php'; ?>
        </div>
        <?php require_once APP_ROOT . '/admin2/modelo/pg_portfolio/pg_portfolio1.0/Bodypg_portfolio1.0.php'; ?>
    </div>
    <!-- Scripts -->
