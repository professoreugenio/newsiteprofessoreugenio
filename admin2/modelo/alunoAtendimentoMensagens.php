...
<head>
    <?php require APP_ROOT . '/admin2/v1.0/head.php'; ?>
...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php require_once APP_ROOT . '/admin2/modelo/atendimento1.0/Subnav.php'; ?>

        </div>
        <?php require_once APP_ROOT . '/admin2/modelo/atendimento1.0/BodyAtendimentoMensagens.php'; ?>
