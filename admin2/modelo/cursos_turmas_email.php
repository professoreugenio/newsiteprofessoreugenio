...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php require_once APP_ROOT . '/admin2/modelo/cursosv1.0/SubnavSecundarioTurma.php'; ?>

            <?php require_once APP_ROOT . '/admin2/modelo/cursosv1.0/SubnavCursosEditar.php'; ?>
        </div>
        <!-- CORPO PÁGINA -->
       
        <?php require_once APP_ROOT . '/admin2/modelo/cursosv1.0/BodyTurmasListaEmail2.0.php'; ?>
    </div>
    <!-- Scripts -->
