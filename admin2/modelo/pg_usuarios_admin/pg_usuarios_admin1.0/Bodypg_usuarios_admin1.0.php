<?php
/**
 * Bodypg_usuarios_admin1.0.php
 * Estrutura base para o conteúdo principal da página pg_usuarios_admin
 */
?>
<div class="card shadow-sm" data-aos="fade-up">
    <div class="card-body">
        <h5 class="card-title text-primary mb-3">Bem-vindo à página pg_usuarios_admin</h5>
        <p class="text-muted">
