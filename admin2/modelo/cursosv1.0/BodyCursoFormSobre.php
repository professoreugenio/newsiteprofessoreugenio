...
<form id="formEditarLeadCurso" action=" cursosv1.0/SalvarLeadCurso.php" method="post">
    ...
    <div class="mb-3">
        <label for="detalhes" class="form-label fw-bold">Section Sobre</label>
        <textarea name="sobre" id="sobre" class="form-control summernote" rows="6"><?= stripslashes($sobre) ?></textarea>
    </div>
