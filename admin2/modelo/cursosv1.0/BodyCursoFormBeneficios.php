...
<form id="formEditarLeadCurso" action=" cursosv1.0/SalvarLeadCurso.php" method="post">
    ...
    <div class="mb-3">
        <label for="detalhes" class="form-label fw-bold">Section Benefícios</label>
        <textarea name="beneficios" id="beneficios" class="form-control summernote" rows="6"><?= stripslashes($beneficios) ?></textarea>
    </div>
