...
<head>
    ...
    <link rel="stylesheet" href="/admin2/modelo/vendas1.0/CSS_vendas.css?<?= time(); ?>">
...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <?php require_once APP_ROOT . '/admin2/modelo/cursosv1.0/BodyCursoFormLeadEditar.php'; ?>
    </div>
    <!-- Scripts -->
    <script src="../v1.0/PainelLateral.js"></script>

    <script src="cursosv1.0/JS_cursoLeadEditar.js?<?= time(); ?>"></script>
