...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <!-- CORPO PÁGINA -->
        <h5>
            <?= "Data ini: " . $datainiciost . " Data fim: " . $datafimst ?> <a href="cursos_turmas.php?id=<?= $_GET['id'] ?>">todas as turmas</a>
        </h5>
        <?php require_once APP_ROOT . '/admin2/modelo/cursosv1.0/BodyTurmaListaAlunos.php'; ?>
    </div>
    <!-- Scripts -->
