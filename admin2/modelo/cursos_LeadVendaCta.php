...
<head>
    ...
    <link rel="stylesheet" href="/vendasv1.0/css/CSS_config.css?<?= time(); ?>">
...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <!-- CORPO PÁGINA -->
        <?php require_once APP_ROOT . '/admin2/modelo/cursosv1.0/BodyCursoFormCta.php'; ?>
    </div>
    <!-- Scripts -->
    ...
    <script src="cursosv1.0/JS_cursoLeadEditarCta.js?<?= time(); ?>"></script>
