...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="mt-4">
                <h3>
                    <i class="bi bi-camera" aria-hidden="true"></i> Afiliados - Campanhas - Editar
                </h3>
                </h3>
                <small><?= $saudacao; ?></small><br>
                <small><?= diadasemana($data, 2); ?></small>
            </div>
            <?php require_once APP_ROOT . '/admin2/modelo/afiliados1.0/Subnav.php'; ?>
        </div>
        <?php require_once APP_ROOT . '/admin2/modelo/afiliados1.0/BodyAfiliadoformProdutoEditar.php'; ?>
    </div>
    <!-- Scripts -->
