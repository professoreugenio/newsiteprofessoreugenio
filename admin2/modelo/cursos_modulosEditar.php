...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="mt-4">
                <h3><i class="bi bi-journal-text me-2"></i> <?= $Nomecurso ?></h3>
                <h5><i class="bi bi-journal-text me-2"></i> Módulo <?= $Nomemodulo  ?></h5>
        ...
        <?php require_once APP_ROOT . '/admin2/modelo/modulosv1.0/BodyModuloFormEdit.php'; ?>
    </div>
    <!-- Scripts -->
