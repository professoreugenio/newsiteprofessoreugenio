...
?>
<?php require APP_ROOT . '/admin2/modelo/cursosv1.0/QueryCursos.php'; ?>
<?php require APP_ROOT . '/admin2/modelo/modulosv1.0/QueryModulos.php'; ?>
<?php require APP_ROOT . '/admin2/modelo/publicacoesv1.0/QueryPublicacao.php'; ?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="mt-4">
                <h3><i class="bi bi-journal-text me-2"></i> Módulo <?= $Nomecurso ?> Com:<?= $comercial  ?></h3>
            </div>
        ...
        echo $comercial;
        if ($comercial == 1):
            require_once APP_ROOT . '/admin2/modelo/publicacoesv1.0/BodyPublicacaoFormEditar.php';
        else:
            require_once APP_ROOT . '/admin2/modelo/publicacoesv1.0/BodyPublicacaoFormEditar.php';
    ...
    <script src="publicacoesv1.0/JS_publicacoesEditartitulos.js"></script>
    <!-- Popper e Bootstrap -->
