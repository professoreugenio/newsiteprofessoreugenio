<?php
/**
 * Bodypg_contato1.0.php
 * Estrutura base para o conteúdo principal da página pg_contato
 */
?>
<div class="card shadow-sm" data-aos="fade-up">
    <div class="card-body">
        <h5 class="card-title text-primary mb-3">Bem-vindo à página pg_contato</h5>
        <p class="text-muted">
