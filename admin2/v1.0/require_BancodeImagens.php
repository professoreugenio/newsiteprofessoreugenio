                ...
                <div class="card-body d-flex flex-column gap-2">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h6 class="title mb-0">Banco de Imagens</h6>
                        </div>
                    </div>
                    <span class="label text-muted">Gerencie suas mídias</span>
                    <a href="bancodeImagens.php" class="stretched-link" aria-label="Abrir Banco de Imagens"></a>
