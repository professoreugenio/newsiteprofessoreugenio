...
<body id="adminLayout">
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="mt-4">
                <h3><i class="bi bi-journal-text me-2"></i> PUBLICAÇÕES</h3>
            </div>
            <?php require_once APP_ROOT . '/admin2/pg_publicacoes/publicacoes1.0/Subnav.php'; ?>
        </div>
        <?php require_once APP_ROOT . '/admin2/pg_publicacoes/publicacoes1.0/Bodypg_publicacoes1.0.php'; ?>
    </div>
    <!-- Scripts -->
