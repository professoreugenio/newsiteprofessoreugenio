        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <div class="card p-4 shadow">
                    ...
                    <p class="lead mb-4">Logo estaremos disponibilizando as inscrições para o cursos de <b><?php echo $nomeCurso;  ?></b> online.</p>

                    <p class="mb-4">Para mais informações Entre em contato e receba atualizações diretamente no seu WhatsApp ou e-mail.
                    </p>
                    <div id="contato">
